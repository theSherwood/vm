...
| **Endpoint self-mint** — a domain minting a live offer over its *own* impl-export (the distrust-parent variant; parent-mediated sibling-as-service is BUILT) | PROCESS.md §4 "S9 rescope" | todo — small; composes with detached windows |
