...
| ↳ Personality `\|` wiring — `c_shell` pipelines over region rings instead of memfs temp files; redirects on *external* commands | STAGE1.md item 6 / Power-2 | todo — both backends now run concurrent stages |
